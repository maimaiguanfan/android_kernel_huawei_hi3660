...
static struct hs_res_detect_func g_hi6402HsResDetectFunc = {
	.hs_res_detect = NULL,
	.hs_path_enable = NULL,
...
static struct hi64xx_hs_cfg hi6402_hs_cfg = {
	...
	.res_detect_func = &g_hi6402HsResDetectFunc,
};
...
static void hi6402_digital_clk_disable(void)
{
	pr_info("%s\n",__func__);
	/* disable audio clk */
...
static void hi6402_digital_clk_enable(void)
{
	pr_info("%s\n",__func__);
	/* enable audio clk */
